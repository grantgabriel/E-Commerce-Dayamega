<?php
    ...
    $product_sql = "SELECT * FROM all_products WHERE product_id = '$product_id'";
    ...
    if(isset($_POST['update-button'])) {
        ...
        $dealer_prices_query = "CALL updateItemPrices('$product_id', '$dealer_prices')";
        $dealer_prices_sql = mysqli_query($connect, $dealer_prices_query);

        $stock_query = "CALL updateItemStocks('$product_id', '$stock')";
        $stock_sql = mysqli_query($connect, $stock_query);
        $redirect = true;
    }
?>
<!DOCTYPE html>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 text-center mx-auto">
                            <h1 class="text-white mb-2 mt-5">Update Product!</h1>
                            <p class="text-lead text-white">Update stocks, or even dealers prices here!!</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <form role="form text-left" method="POST" name="sign-up-form">
                                    ...
                                    <div class="text-center">
                                        <button class="btn bg-gradient-dark w-100 my-4 mb-2" type="submit" name="update-button" id="submit">Update!</button>
                                    </div>
                                </form>
