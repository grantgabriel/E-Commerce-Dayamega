                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 align-middle text-center">Category ID & Name</th>
                                    ...
                                    <tbody>
                                        ...
                                        $log_category_sql = "SELECT * FROM log_category";
                                        $log_category_query = mysqli_query($connect, $log_category_sql);

                                        while ($data = mysqli_fetch_assoc($log_category_query)) {
                                        ?>
                                            <tr>
                                                <td>
