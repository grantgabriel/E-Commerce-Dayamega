      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Log Orders</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Log Orders</h6>
        </nav>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 align-middle text-center">Order ID</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 align-middle text-center ">Status</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 align-middle text-center ">Actioner</th>
                  ...
                  <tbody>
                    ...
                    $log_order_status_sql = "SELECT * FROM log_order_status ORDER BY time DESC";
                    $log_order_status_query = mysqli_query($connect, $log_order_status_sql);

                    while ($data = mysqli_fetch_assoc($log_order_status_query)) {
                    ?>
                      <tr>
                        <td>
                        ...
                        <td class="align-middle text-center">
                          <p class="text-xs text-secondary mb-0"><?= $data['actioner'] ?></p>
                        </td>
                        <td class="align-middle text-center">
