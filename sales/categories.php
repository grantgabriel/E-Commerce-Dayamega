                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 align-middle text-center ">Category ID</th>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="text-xs text-secondary mb-0"><?= $data['category'] ?></p>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 text-center mx-auto">
                            <h1 class="text-white mb-2 mt-5">Not Enough Cateogries?!</h1>
                            <p class="text-lead text-white">Add up new categories here!!</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-7 col-lg-5 col-md-7 mx-auto">
                        <div class="card z-index-0">
                            <div class="card-header text-center pt-4">
                                <h5>Categories Form</h5>
                            </div>
                            <div class="card-body">
                                <form role="form text-left" method="POST" name="sign-up-form">
                                    <label>Category Name</label>
                                    <div class="mb-3">
                                        <input type="text" class="form-control" placeholder="Category name here..." aria-label="Name" aria-describedby="email-addon" name="category" id="name">
                                    </div>
                                    <div class="text-center">
                                        <button class="btn bg-gradient-dark w-100 my-4 mb-2" type="submit" name="add-category-button" id="submit">Add Categories!</button>
                                    </div>
                                </form>
                                ...
                                <?php
                                    ...
                                    if(isset($_POST['add-category-button'])) {
                                        ...
                                        $id = generateUniqueID();
                                        $cateory_query = "CALL addCategory('$id', '$category')";
                                        
                                        $cateory_sql = mysqli_query($connect, $cateory_query);
