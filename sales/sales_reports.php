...
$total_sales_sql = "SELECT totalSales() AS totalSales";
  $total_sales_query = mysqli_query($connect, $total_sales_sql);
                ...
                <div class="col-12">
                    <div class="card mb-4">
                      <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <h6>Sales Reports</h6>
                        <div class="mb-3">
                            <a href="sales_reports_pdf.php" target="_blank" class="btn btn-primary">Cetak Laporan</a>
                        </div>
                        <form action="sales_reports_monthly.php"></form>
                        <div class="mb-3">
                          <input type="text" class="form-control" placeholder="Email" aria-label="Email" aria-describedby="email-addon" name="email" id="name">
                        </div>
                      </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Product ID & Product Name</th>
                                    ...
                                    <tbody>
                                        ...
                                        $log_account_sql = "SELECT * FROM sales_report";
                                        $log_account_query = mysqli_query($connect, $log_account_sql);

                                        while ($data = mysqli_fetch_assoc($log_account_query)) {
                                        ?>
                                            <tr>
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold"> <?= $data['order_id'] ?></span>
                                                </td>
                                                <td>
                                                    <p class="text-xs text-secondary mb-0"><?= $data['order_date'] ?></p>
                                                </td>
                                                <td>
                                                    <p class="text-xs text-secondary mb-0"><?= $data['customer_name'] ?></p>
                                                </td>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            ...
                                                            <p class="text-xs text-secondary mb-0"><?= $data['product_id'] ?></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold"> <?= $data['total'] ?></span>
                                                </td>
                                                <td class="align-middle text-center">
