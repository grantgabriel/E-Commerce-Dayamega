                ...
                <div class="col-12">
                    <div class="card mb-4">
                      <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <h6>Sales Reports</h6>
                        <div class="mb-3">
                          <form action="sales_reports_monthly_pdf.php" method="POST">
                            <button class="btn btn-primary">Cetak Laporan</button>
                            <input type="text" hidden value="<?= $month_num ?>" name="month_num" id="month_num">
                          </form>
                        </div>
                      </div>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        $log_account_sql = "SELECT * FROM sales_report WHERE MONTH(order_date) = '$month_num'";
